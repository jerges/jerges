const translations = {
  en: {
    ...
    'builds.apps.desc':   'Custom web applications, REST APIs and backend systems designed to scale from day one.',
  ...
  es: {
    ...
    'builds.apps.title':  'Apps',
    'builds.apps.desc':   'Aplicaciones web, APIs REST y sistemas backend diseñados para escalar desde el primer día.',
