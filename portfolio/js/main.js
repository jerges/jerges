const translations = {
  en: {
    ...
    'hero.sub':       'Backend systems, AI agents and automation tools — from idea to production.',
    'hero.scroll':    'See my work ↓',
    'chip.apps':      'Apps',
    'chip.ai':        'AI Agents',
    'chip.automation':'Automation',
    'builds.label':       'What I build',
    'builds.apps.title':  'Apps',
    'builds.apps.desc':   'E-commerce platforms, backoffice tools and custom web applications — backend systems built to scale.',
    'builds.ai.title':    'AI Agents',
    'builds.ai.desc':     'Autonomous agents that work for your business 24/7 — via Telegram, WhatsApp and Slack. They respond, execute and automate without you lifting a finger.',
    'builds.ai.badge':    'New',
    'builds.auto.title':  'Automation',
    'builds.auto.desc':   'Event-driven workflows and integrations that connect your tools, eliminate manual work and keep your business running on its own.',
  ...
  es: {
    ...
    'hero.sub':       'Sistemas backend, agentes IA y herramientas de automatización — de la idea a producción.',
    'hero.scroll':    'Ver mi trabajo ↓',
    'chip.apps':      'Apps',
    'chip.ai':        'Agentes IA',
    'chip.automation':'Automatización',
    'builds.label':       'Qué construyo',
    'builds.apps.title':  'Apps',
    'builds.apps.desc':   'Plataformas de e-commerce, herramientas de backoffice y aplicaciones web a medida — sistemas backend diseñados para escalar.',
    'builds.ai.title':    'Agentes IA',
    'builds.ai.desc':     'Agentes autónomos que trabajan por tu negocio 24h — por Telegram, WhatsApp y Slack. Responden, ejecutan y automatizan sin que muevas un dedo.',
    'builds.ai.badge':    'Nuevo',
    'builds.auto.title':  'Automatización',
    'builds.auto.desc':   'Flujos de trabajo e integraciones que conectan tus herramientas, eliminan el trabajo manual y mantienen tu negocio funcionando solo.',
